    ...
    <>
      <div className="relative flex flex-wrap-reverse  h-[65rem] md:relative md:flex md:h-[60rem] 2xl:relative 2xl:flex 2xl:h-[42rem]">
        <div className="flex flex-col items-start p-8 md:flex md:flex-col md:w-1/2 md:items-start md:text-left">
          <div className="relative top-[-8rem] md:relative md:left-[10.3rem] md:top-[-5rem] 2xl:top-[3rem]">
            <h2 className="font-sans font-medium text-[2.75rem] text-[#373F41] md:font-sans md:font-normal md:h-[9rem] md:w-[46.25rem] md:text-[3.75rem] md:text-[#373F41] md:leading-[4.5rem]">
              ...
              <img
                src="/clock.svg"
                alt=""
                className="relative top-[2rem] md:relative md:top-[-4.5rem]"
              />
              <span className="relative text-[20px] top-[-1.75rem] left-[3rem] text-[#000000]/[0.68] md:relative md:text-[25px] md:top-[-8.75rem] md:left-[3rem] md:text-[#000000]/[0.68] 2xl:relative 2xl:text-[25px] 2xl:top-[-8.75rem] 2xl:left-[3rem] 2xl:text-[#000000]/[0.68]">
          ...
          <a href="#" className="self-center md:self-auto">
            <button className="relative top-[3rem] w-[14.5rem] h-[3rem] border-2 border-[#1B4996] text-lg text-[#1B4996] rounded cursor-pointer md:left-[21rem] 2xl:top-[10rem] 2xl:left-[21rem]">
              Download Brochure
            </button>
          </a>
        </div>
