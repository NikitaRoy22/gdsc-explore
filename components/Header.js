    ...
    <>
      ...
      <div className="relative flex flex-wrap-reverse  h-[65rem] md:relative md:flex md:h-[60rem] 2xl:relative 2xl:flex 2xl:h-[42rem]">
        <div className="flex flex-col items-start p-8 md:flex md:flex-col md:w-1/2 md:items-start md:text-left">
          ...
          <button className="relative self-center top-[7rem] w-[8.6rem] h-[3rem] bg-[#3C64B1] rounded font-sans text-lg text-white cursor-pointer  hover:shadow-xl md:relative md:left-[10.3rem] md:top-[9rem] md:w-[8.6rem] md:h-[3rem] md:bg-[#3C64B1] md:rounded md:font-sans md:text-lg md:text-white md:cursor-pointer md:self-start 2xl:top-[17rem]">
            Register Now
          </button>
        </div>
        ...
        <div className="pl-8 2xl:flex 2xl:w-1/2 2xl:justify-center w-[100%]">
          <div className="relative top-[4.0625rem] h-[20rem] w-[90%] md:relative md:top-[4.0625rem] md:h-[20rem] md:w-[90%] 2xl:relative 2xl:top-[4.0625rem] 2xl:h-[32.75rem] 2xl:w-[90%]">
